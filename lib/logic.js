 ...
 async function changeAbnormal(changeAbnormal){
     ...
     * @param {token.SealAccount} IssueAccount
     */
     ...
     async function sealAccount(sealAccount){
        ...
        if(CompanyRegistry.exsits(sealAccount.email)){
        ...
        if(UserRegistry.exists(sealAccount.email)){
            const user = UserRegistry.get(sealAccount.email);
            user.state = -1;
